...
function getInitialState(): DBState {
  ...
  const defaultTeachers: Record<string, Teacher> = {
    "mana@samsen.ac.th": {
      ...
      affiliation: "สำนักงานเขตพื้นที่การศึกษามัธยมศึกษากรุงเทพมหานคร เขต 1",
      phone: "081-234-5678",
      slug: "mana-samsen",
      academicYear: "2569",
      status: "approved",
  ...
  manaIndicators["1.1"].description = "วิเคราะห์หลักสูตรแกนกลางการศึกษาขั้นพื้นฐาน พุทธศักราช 2551 (ฉบับปรับปรุง พ.ศ. 2560) และหลักสูตรสถานศึกษาโรงเรียนสามเสนวิทยาลัย กลุ่มสาระการเรียนรู้วิทยาศาสตร์และเทคโนโลยี รายวิชาฟิสิกส์ ม.4 นำมาจัดทำคำอธิบายรายวิชา โครงสร้างรายวิชา และหน่วยการเรียนรู้ที่เน้นผู้เรียนเป็นสำคัญ";
  ...
  const manaChallenge: PACleaningChallenge = {
    part: 2,
    title: "การแก้ปัญหาผลสัมฤทธิ์ทางการเรียนและการคิดแก้ปัญหาเรื่องแรงและกฎการเคลื่อนที่ของนักเรียน ม.4 โรงเรียนสามเสนวิทยาลัย โดยการสอนด้วยรูปแบบ Active Learning สอดแทรกเกมจำลองสถานการณ์",
    ...
    quantitativeOutput: "นักเรียนชั้น ม.4/1 โรงเรียนสามเสนวิทยาลัย จำนวน 40 คน เข้าเรียนในรายวิชาฟิสิกส์ มีผลสัมฤทธิ์ทางการเรียนเฉลี่ยเพิ่มขึ้นอย่างน้อยร้อยละ 15 และมากกว่าร้อยละ 80 ของผู้เรียนมีคะแนนผ่านเกณฑ์ที่กำหนด (ร้อยละ 75)",
...
VALUES ('t1-mana', 'mana@samsen.ac.th', 'ครูมานะ รักการสอน', 'ครูวิทยฐานะชำนาญการพิเศษ', 'โรงเรียนสามเสนวิทยาลัย', 'สพม.กรุงเทพมหานคร เขต 1', '081-234-5678', 'mana-samsen', '2569', 'approved')
